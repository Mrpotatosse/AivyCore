...
namespace AivyDofus.DofusMap.Visualizer
{
    ...
    public partial class MapControl : UserControl
    {
        ...
        {
            CellOver?.Invoke(this, cell, last);
        }
        ...
        public MapControl()
        {
            ...
            StatesColors = new Dictionary<CellState, Color>
                               {
                                   {CellState.Walkable, Color.White},
    ...
    {
        public static CellState HighestState = System.Enum.GetValues(typeof(CellState)).Cast<CellState>().Max();
