...
namespace AivyDofus.Pathfinding
{
    public class Cell
    {
        ...
        public Cell(CellData cell, bool changeMap, bool walkable, bool los, int column, int line, int id, Point location)
        {
            Data = cell;
            ChangeMap = changeMap;
            Walkable = walkable;
        ...
        public List<int> GetConnectedCells()
        {
            ...
            list.Add(setFromCoords((int)Location.X - 1, (int)Location.Y));
            list.Add(setFromCoords((int)Location.X - 1, (int)Location.Y - 1));
            list.Add(setFromCoords((int)Location.X + 1, (int)Location.Y));
            list.Add(setFromCoords((int)Location.X, (int)Location.Y + 1));
            return list;
        }
        public int GetCellInDirection(DirectionsEnum direction, short step)
        {
            ...
            return setFromCoords((int)ThatCell.X, (int)ThatCell.Y);
        }
        ...
        private int setFromCoords(int X, int Y)
        {
